...
xmin=0.
xmax=1. !! 1 for cartesian 2 for spherical
...
!IMPLEMENTAZIONE CONDIZIONI INIZIALI
 ...
 gam=5./3. !!5/3 = 1.6
 cv=kbol/((gam-1.)*mu*mp)    !! warning: this is right for gam = 5/3 !!
 t=0.
 tmax=2.3 !!0.5 for spherical, 0.245 for cartesian
 c2=3.
 cfl=0.5
